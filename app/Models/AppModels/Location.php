...
$locations = DB::table('location')->where('zone_id', $zone_id)->get();

            $responseData = array('success' => '1', 'data' => $locations, 'message' => "Returned all states.");
        } else {
            $responseData = array('success' => '0', 'data' => array(), 'message' => "Unauthenticated call.");
        }
        $response = json_encode($responseData);
