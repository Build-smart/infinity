...
class Categories extends Model
{
    ...
    public function insertcategorydescription($categoryNameSub,$categories_id,$languages_data_id,$description){
    ...
    public function updatedescription($categories_name,$languages_data,$categories_id,$description){
