...
class Customers extends Model
{
    ...
    public function updaterecord($customer_data,$user_id,$user_data,$request){
    ...
    $user_name = $request->first_name.' '.$request->last_name;
      ...
      //Account Activate
      if($request->status == 1){
      	accountactivate($phone,$user_name);
      }
    ...
    $parameter = $request->parameter;
        ...
        { 
        	...
        	case 'ID':
        		...
        		'address_book.entry_street_address as entry_street_address', 'address_book.entry_suburb as entry_suburb',
        		'address_book.entry_postcode as entry_postcode', 'address_book.entry_city as entry_city',
        		'address_book.entry_state as entry_state', 'countries.countries_id as countries_id,countries.countries_name as countries_name,
           countries.countries_iso_code_2 as countries_iso_code_2, countries.countries_iso_code_3 as countries_iso_code_3,
           countries.address_format_id as address_format_id,countries.country_code as country_code
                    .*', 'zones.zone_name')
           ...
           countries.countries_iso_code_2 as countries_iso_code_2, countries.countries_iso_code_3 as countries_iso_code_3,
           countries.address_format_id as address_format_id,countries.country_code as country_code
                    .*', 'zones.zone_name','image_categories.path as path')
