...
public function lowinstock($request)
    ...
    { 
    	...
    	->selectRaw("date_purchased, orders.orders_id as orders_id, count('orders.orders_id') as total_orders, count('orders_products.orders_id') as total_products, sum(order_price) as total_price");
...
//die;
    ...
    //	$result['minMax'] = $minMax;
      ...
      public function locationlowinstock($request)
    {
      ...
      public function locationoutofstock($request)
    {
