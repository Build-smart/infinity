  ...
  public function __construct()
  {
    ...
    public function edit($manufacturers_id){
        ...
        $editManufacturer = DB::table('manufacturers')
            ...
            ->select('manufacturers.manufacturers_id as id','manufacturers.categories_id as category_id', 'manufacturer_image as image',  'manufacturers.manufacturer_name as name', 'manufacturers_info.manufacturers_url as url', 'manufacturers_info.url_clicked', 'manufacturers_info.date_last_click as clik_date', 'manufacturers.manufacturers_slug as slug','image_categories.path as path')
