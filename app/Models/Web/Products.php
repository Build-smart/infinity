...
/*	$items = DB::table('categories')
            ...
            $items = Cache::rememberForever('website_categories_items', function ()   {
...
*/
 ...
 $categories->LeftJoin('liked_products', 'liked_products.liked_products_id', '=', 'products.products_id')
                ->select('products.products_id','products.location_id','products.distributor_id','products.distributor_product_price','products.products_model','products.products_price','products.products_image','products.products_type','products.product_segment','products.assured_by',
        ...
        */
            ...
            $categories->LeftJoin('specials', 'specials.products_id', '=', 'products.products_id')
                ->select('products.products_id','products.distributor_id','products.distributor_product_price','products.location_id','products.products_model','products.products_price','products.products_image','products.products_type', 'products.product_segment','products.assured_by',
...
*/
  ...
  $categories->LeftJoin('flash_sale', 'flash_sale.products_id', '=', 'products.products_id')
                ->select(DB::raw(time() . ' as server_time'),'products.products_id','products.distributor_id','products.distributor_product_price','products.location_id','products.products_model','products.products_price','products.products_image', 'products.products_type','products.product_segment','products.assured_by',
...
*/
  ...
  $categories->LeftJoin('flash_sale', 'flash_sale.products_id', '=', 'products.products_id')
                ->select(DB::raw(time() . ' as server_time'),'products.distributor_id','products.distributor_product_price', 'products.products_id','products.location_id', 'products.products_model','products.products_price','products.products_image','products.products_type','products.product_segment','products.assured_by',
...
//end of discount.
        ...
        if (!empty($data['brands']) && $data['brands'] != "") {
            ...
            ->where('products.location_id', '=', Session::get('location_id'));
...
$categories->where('products_to_categories.categories_id', '=', $data['categories_id']);
 ...
 if (!empty(Session::get('location_id')) && Session::get('location_id') != "") {
            $categories->where('products.location_id', '=', Session::get('location_id'));
...
//below code commented on 3 feb 2022 for filters search text like cement 
   /*   
   ...
   $price = DB::table('products_to_categories')
        ...
        $product = DB::table('products')
            ...
            ->leftJoin('manufacturers_info', 'manufacturers.manufacturers_id', '=', 'manufacturers_info.manufacturers_id')
             ...
             //joins the product table and product_Attributes table if the data matches on both table only that data is coming
 ->Join('products_attributes', 'products_attributes.products_id', '=', 'products.products_id')
        ...
        if (isset($categories_id) and !empty($categories_id)) {
            $product->where('products_to_categories.categories_id', '=', $categories_id);
              ...
              //based on location retrieving the data
$product->where('products.location_id', '=', Session::get('location_id'));
...
*/
			...
			// when it is search
		$categories_id1 = $data['categories_id1'];
	 
		if($categories_id1 != "")
		{

		   $maxPrice  =  $data['products_price'];
   ...
   if($categories_id1 != ""){
        ...
        if (isset($categories_id1) and !empty($categories_id1)) {
            $product
        ...
        if (isset($categories_id1) and !empty($categories_id1)) {
            $product->where('products_to_categories.categories_id', '=', $categories_id1);
        }
