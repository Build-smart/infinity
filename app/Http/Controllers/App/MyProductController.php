...
class MyProductController extends Controller
{
    ...
    $categoryResponse = Product::allcategories($request);
		...
		//get all Associated Partners brands 
	public function allAssociatedPartners(Request $request){
    $categoryResponse = Product::allAssociatedPartners($request);
		print $categoryResponse;
	}
    ...
    $categoryResponse = Product::getsingleproductdetails($request);
		print $categoryResponse;
	}
