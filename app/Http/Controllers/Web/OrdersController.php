...
class OrdersController extends Controller
{
    ...
    public function checkout(Request $request)
    {
        ...
        if (count($result['cart']) == 0) {
            ...
            //get tax based on gst terms ... igst or gst .... based on the shipping address....
            ...
            if (count($result['cart']) > 0) {
                ...
                foreach ($result['cart'] as $products) {
                    ...
                    $price += $products->final_price * $products->customers_basket_quantity;
                                        ...
                                        $distributor_price += $products->distributor_final_price * $products->customers_basket_quantity;

                    
                }
                session(['products_price' => $price]);
                
                                session(['distributor_price' => $distributor_price]);
            ...
            return view("web.checkout", ['title' => $title, 'final_theme' => $final_theme,'remainingwallet_amount' => $remainingwallet_amount])->with('result', $result);
        }
    ...
    public function checkout_shipping_address(Request $request)
    {
        ...
        foreach ($request->all() as $key => $value) {
            ...
            }else if ($key == 'delivery_alternate_phone') {
                $billing_data['billing_alternate_phone'] = $value;
            }
        }
...
//         ->sum('orders.order_price');
   ...
   /**   BUILDERMART WALLET**/
        ...
        $payments_setting = $this->order->payments_setting_for_buildermart_wallet();
