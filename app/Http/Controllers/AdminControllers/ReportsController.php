...
use App\Models\Core\SaleReports;
...
{
   public function __construct(Reports $reports, Setting $setting, Customers $customers, Products $products, SaleReports $salereports) {
    ...
    public function statsProductsPurchased(Request $request)
   {
    ...
    //lowinstock  added by Adinarayana
    public function lowinstock(Request $request)
    {
    $title = array('pageTitle' => Lang::get("labels.outOfStock"));
    $result['lowQunatity'] = $this->reports->lowinstock($request);
    ...
    */
    ...
    public function stockreport(Request $request)
    {
    	$title = array('pageTitle' => Lang::get("labels.Sales Report"));
    	 ...
    	 $result = $this->reports->productsstock();
    
    	$myVar = new SiteSettingController();
    	$result['setting'] = $myVar->getSetting();
    	$result['commonContent'] = $myVar->Setting->commonContent();
    
    	return view("admin.reports.stockreport", $title)->with('result', $result);
    }
      ...
      public function salesreports(Request $request)
    {
    	...
    	$result = $this->salereports->productsstock();
    
    	$myVar = new SiteSettingController();
    	$result['setting'] = $myVar->getSetting();
    	$result['commonContent'] = $myVar->Setting->commonContent();
    
    	return view("admin.reports.salesreports", $title)->with('result', $result);
    }
       ...
       public function stockreportprint(Request $request)
    {
    	...
    	return view("admin.reports.stockreportprint", $title)->with('result', $result);
    }
 
    
    
       public function locationoutofstock(Request $request)
    {
    	$title = array('pageTitle' => Lang::get("labels.outOfStock"));
    	$result['reports'] = $this->reports->locationoutofstock($request);
    
    	$myVar = new SiteSettingController();
    	$result['currency'] = $myVar->getSetting();
    	$result['commonContent'] = $myVar->Setting->commonContent();
    
    	return view("admin.reports.locationreports.location_outofstock", $title)->with('result', $result);
    }
    
    
    public function locationoutofstockprint(Request $request)
    {
    	$title = array('pageTitle' => Lang::get("labels.outOfStock"));
    	$result['reports'] = $this->reports->locationoutofstock($request);
    	...
    	return view("admin.reports.locationreports.location_outofstockprint", $title)->with('result', $result);
    }



    //locationlowinstock  added by Bharath
    public function locationlowinstock(Request $request)
    {
    	$title = array('pageTitle' => Lang::get("labels.outOfStock"));
    	$result['lowQunatity'] = $this->reports->locationlowinstock($request);
    	 
    	$myVar = new SiteSettingController();
    	$result['currency'] = $myVar->getSetting();
    	$result['commonContent'] = $myVar->Setting->commonContent();
    	 
    	return view("admin.reports.locationreports.location_lowinstock", $title)->with('result', $result);
    }
    ...
    public function locationstockreport(Request $request)
    {
    	...
    	$result = $this->reports->locationproductsstock();
    
    	$myVar = new SiteSettingController();
    	$result['setting'] = $myVar->getSetting();
    	$result['commonContent'] = $myVar->Setting->commonContent();
    
    	return view("admin.reports.locationreports.location_stockreport", $title)->with('result', $result);
    }
    
    
    public function locationstockreportprint(Request $request)
    {
    	$title = array('pageTitle' => Lang::get("labels.Sales Report"));
    	...
    	return view("admin.reports.locationreports.location_stockreportprint", $title)->with('result', $result);
    }
    
    public function locationsalesreports(Request $request)
    {
    	$title = array('pageTitle' => Lang::get("labels.Sales Report"));
    
    	$result = $this->salereports->locationproductsstock();
    
    	$myVar = new SiteSettingController();
    	$result['setting'] = $myVar->getSetting();
    	$result['commonContent'] = $myVar->Setting->commonContent();
    
    	return view("admin.reports.locationreports.location_salesreports", $title)->with('result', $result);
    }
