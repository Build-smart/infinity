...
class CategoriesController extends Controller
{
  ...
  public function insert(Request $request){
        ...
        foreach($languages as $languages_data){
            ...
            $subcatoger_des = $this->Categories->insertcategorydescription($categoryNameSub,$categories_id,$languages_data_id,$description);
        }
     ...
     foreach($languages as $languages_data){
       ...
       $checkExist = $this->Categories->checkExit($categories_id,$languages_data);
         ...
         if(count($checkExist)>0){
           $category_des_update = $this->Categories->updatedescription($categories_name,$languages_data,$categories_id,$description);
       }else{
