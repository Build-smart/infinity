    ...
    protected $routeMiddleware = [
      ...
      'Customer' => \App\Http\Middleware\RedirectIfNotCustomer::class,
        ...
        'add_tax' => \App\Http\Middleware\tax\add_tax::class,
    		...
    		'edit_orderdelivery' => \App\Http\Middleware\orderdelivery\edit_orderdelivery::class,
    		'delivery_view_order' => \App\Http\Middleware\orderdelivery\delivery_view_order::class,
    		
    		
    		'inventory_view' => \App\Http\Middleware\inventory\inventory_view::class,
    		'inventory_update' => \App\Http\Middleware\inventory\inventory_update::class,
    		
    		    		'location_view_order' => \App\Http\Middleware\location_orders\location_view_order::class,
'locationreport' => \App\Http\Middleware\location_report\locationreport::class,
