                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Add Product Order Status</h3>
                        </div>
                                ...
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            {!! Form::open(array('url' =>'admin/addnewproductorderstatus', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}

 												 
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-2 control-label">Product Order Status</label>
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" name="product_orders_status_name" Placeholder="Enter Product Order Status" class="form-control field-validate"  >
