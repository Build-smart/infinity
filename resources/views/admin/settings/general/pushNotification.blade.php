                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                {{ trans('labels.OnesignalSenderidText') }}</span>
                                                ...
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">Distributor {{ trans('labels.OnesignalAppid') }}</label>
                                                    <div class="col-sm-10 col-md-4">
                                                        {!! Form::text($result['settings'][150]->name,  $result['settings'][150]->value, array('class'=>'form-control', 'id'=>$result['settings'][150]->name)) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;">
                                {{ trans('labels.OnesignalAppidText') }}</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">Distributor {{ trans('labels.OnesignalSenderid') }}</label>
                                                    <div class="col-sm-10 col-md-4">
                                                        {!! Form::text($result['settings'][151]->name,  $result['settings'][151]->value, array('class'=>'form-control', 'id'=>$result['settings'][151]->name)) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;">
                                {{ trans('labels.OnesignalSenderidText') }}</span>
                                                    </div>
                                                </div>
