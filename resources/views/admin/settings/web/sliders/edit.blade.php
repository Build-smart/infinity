...
<!--                                 <div class="form-group productContent" @if($result['sliders']->type!='product') st yle="display: none" @endif> -->
...
<!--                                       @ endforeach -->
<!--                                       </select> -->
<!--                                      <span class="help-block" st yle="font-weight: normal;font-size: 11px;margin-bottom: 0;"> -->
