<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      ?>
        <li class="treeview {{ Request::is('admin/locationdashboard') ? 'active' : '' }}">
          <a href="{{ URL::to('admin/locationdashboard/this_month')}}">
            <i class="fa fa-dashboard"></i> <span>{{ trans('labels.header_dashboard') }}</span>
          </a>
        </li>
         <?php } ?>
      ...
      <?php
        if($result['commonContent']['roles']!= null and $result['commonContent']['roles']->products_view == 1 or $result['commonContent']['roles']!= null and $result['commonContent']['roles']->categories_view == 1  or $result['commonContent']['roles']!= null and $result['commonContent']['roles']->inventory_view == 1 ){
      ?>
       ...
       <li class="{{ Request::is('admin/products/inactive_products') ? 'active' : '' }} {{ Request::is('admin/products/add') ? 'active' : '' }} {{ Request::is('admin/products/edit/*') ? 'active' : '' }} {{ Request::is('admin/products/attributes/add/*') ? 'active' : '' }} {{ Request::is('admin/addinventory/*') ? 'active' : '' }} {{ Request::is('admin/addproductimages/*') ? 'active' : '' }}"><a href="{{ URL::to('admin/products/inactive_products')}}"><i class="fa fa-circle-o"></i> Inactive Produts</a></li>
      ...
      <li class="treeview {{ Request::is('admin/reviews/display') ? 'active' : '' }} {{ Request::is('admin/sliders') ? 'active' : '' }} {{ Request::is('admin/banners') ? 'active' : '' }} ">
          <a href="#">
            <i class="fa fa-database"></i> <span>Distributors</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
              <li class="treeview {{ Request::is('admin/distributors') ? 'active' : '' }}  {{ Request::is('admin/adddistributor') ? 'active' : '' }}  {{ Request::is('admin/editdistributor/*') ? 'active' : '' }}   ">  
          <a href="{{ URL::to('admin/distributors')}}">
            <i class="fa fa-users" aria-hidden="true"></i> <span>Distributors List</span>
          </a>
        </li>
          <li class="treeview {{ Request::is('admin/distributorbanners') ? 'active' : '' }} {{ Request::is('admin/adddistributorbanner') ? 'active' : '' }} {{ Request::is('admin/editdistributorbanner/*') ? 'active' : '' }}">
         <a href="{{ URL::to('admin/distributorbanners')}}">
         <i class="fa fa-image"></i> Distributor App Slider Images
         </a>
         </li>
           
          <li class="treeview {{ Request::is('admin/distributorbanners') ? 'active' : '' }} {{ Request::is('admin/adddistributorbanner') ? 'active' : '' }} {{ Request::is('admin/editdistributorbanner/*') ? 'active' : '' }}">
     
         <a href="{{ URL::to('admin/distributorbanners/youtubevideolink/7')}}">
         <i class="fa fa-image"></i> Youtube Video Link
         </a>
         </li>
      ...
      <li class="treeview {{ Request::is('admin/locations') ? 'active' : '' }}  {{ Request::is('admin/addlocation') ? 'active' : '' }}  {{ Request::is('admin/editlocation/*') ? 'active' : '' }}   ">
        ...
        <li class="treeview {{ Request::is('admin/promotionalbanners') ? 'active' : '' }}  {{ Request::is('admin/addpromotionalbanner') ? 'active' : '' }}  {{ Request::is('admin/editpromotionalbanner/*') ? 'active' : '' }}   ">
          <a href="{{ URL::to('admin/promotionalbanners')}}">
            <i class="fa fa-image" aria-hidden="true"></i> <span>Promotional Banners</span>
          </a>
        </li>
        
         <li class="{{ Request::is('admin/sliders') ? 'active' : '' }} {{ Request::is('admin/addsliderimage') ? 'active' : '' }} {{ Request::is('admin/editslide/*') ? 'active' : '' }} ">
         <a href="{{ URL::to('admin/sliders')}}">
         <i class="fa fa-image"></i> {{ trans('labels.link_Sliders') }}
         </a>
         </li>
<!--         <li class="treeview {{ Request::is('admin/projects') ? 'active' : '' }}  {{ Request::is('admin/addproject') ? 'active' : '' }}  {{ Request::is('admin/editproject/*') ? 'active' : '' }}   "> -->
<!--           <a href="{{ URL::to('admin/projects')}}"> -->
<!--             <i class="fa fa-users" aria-hidden="true"></i> <span>Projects</span> -->
<!--           </a> -->
<!--         </li> -->


 <li class="treeview {{ Request::is('admin/banners') ? 'active' : '' }} {{ Request::is('admin/addbanner') ? 'active' : '' }} {{ Request::is('admin/editbanner/*') ? 'active' : '' }}">
         <a href="{{ URL::to('admin/banners')}}">
         <i class="fa fa-image"></i> App Slider Images
         </a>
         </li>
        ...
        <li class="treeview {{ Request::is('admin/reedems') ? 'active' : '' }}  {{ Request::is('admin/addreedem') ? 'active' : '' }}  {{ Request::is('admin/editreedem/*') ? 'active' : '' }}   ">
          <a href="{{ URL::to('admin/reedems')}}">
            <i class="fa fa-users" aria-hidden="true"></i> <span>Reedem Values</span>
          </a>
        </li>
        
         <li class="treeview {{ Request::is('admin/rewardpoints') ? 'active' : '' }}  {{ Request::is('admin/addrewardpoint') ? 'active' : '' }}  {{ Request::is('admin/editrewardpoint/*') ? 'active' : '' }}   ">
          <a href="{{ URL::to('admin/rewardpoints')}}">
            <i class="fa fa-users" aria-hidden="true"></i> <span>Reward Points</span>
          </a>
        </li>
        
         <li class="treeview {{ Request::is('admin/wallets') ? 'active' : '' }}  {{ Request::is('admin/addwallet') ? 'active' : '' }}  {{ Request::is('admin/editwallet/*') ? 'active' : '' }}   ">
          <a href="{{ URL::to('admin/wallets')}}">
            <i class="fa fa-users" aria-hidden="true"></i> <span>Wallet</span>
          </a>
        </li>
        
         <li class="treeview {{ Request::is('admin/jobs') ? 'active' : '' }}  {{ Request::is('admin/addjob') ? 'active' : '' }}  {{ Request::is('admin/editjob/*') ? 'active' : '' }}   ">  
          <a href="{{ URL::to('admin/jobs')}}">
            <i class="fa fa-users" aria-hidden="true"></i> <span>Jobs</span>
          </a>
        </li>
        
        
          <li class="treeview {{ Request::is('admin/jobapplicants') ? 'active' : '' }} ">  
          <a href="{{ URL::to('admin/jobapplicants')}}">
            <i class="fa fa-users" aria-hidden="true"></i> <span>Job Applicants</span>
          </a>
        </li>
        
        
         <li class="treeview {{ Request::is('admin/constructionresources') ? 'active' : '' }}  {{ Request::is('admin/addconstructionresource') ? 'active' : '' }}  {{ Request::is('admin/editconstructionresource/*') ? 'active' : '' }}   ">
          <a href="{{ URL::to('admin/constructionresources')}}">
            <i class="fa fa-building" aria-hidden="true"></i> <span>Construction Resources</span>
          </a>
        </li>
        
         <li class="treeview {{ Request::is('admin/widthdrawcashbacks') ? 'active' : '' }}   {{ Request::is('admin/editwidthdrawcashbacks/*') ? 'active' : '' }}   ">
          <a href="{{ URL::to('admin/widthdrawcashbacks')}}">
            <i class="fa fa-money" aria-hidden="true"></i> <span>Widthdraw CashBack Requests</span>
          </a>
        </li>
        
        
           <li class="treeview {{ Request::is('admin/blockips') ? 'active' : '' }}   {{ Request::is('admin/editlocation/*') ? 'active' : '' }}   ">
          <a href="{{ URL::to('admin/blockips')}}">
            <i class="fa fa-map-marker" aria-hidden="true"></i> <span>Block IPS</span>
          </a>
        </li>
...
<?php
        if($result['commonContent']['roles']!= null and $result['commonContent']['roles']->locationorders_view == 1){
      ?>
       <li class="treeview {{ Request::is('admin/orders/locationorderdisplay') ? 'active' : '' }} {{ Request::is('admin/orders/vieworder/*') ? 'active' : '' }}">
              <a href="{{ URL::to('admin/orders/locationorderdisplay')}}" >
                <i class="fa fa-list-ul" aria-hidden="true"></i> <span> Loaction Based Orders</span>
              </a>
            </li>
            
            
            
            <li class="treeview {{ Request::is('admin/locationlowinstock') ? 'active' : '' }} {{ Request::is('admin/locationoutofstock') ? 'active' : '' }} {{ Request::is('admin/statsproductspurchased') ? 'active' : '' }} {{ Request::is('admin/statsproductsliked') ? 'active' : '' }} {{ Request::is('admin/lowinstock') ? 'active' : '' }}">
          <a href="#">
            <i class="fa fa-file-text-o" aria-hidden="true"></i>
  <span>{{ trans('labels.link_reports') }}</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            <li class="{{ Request::is('admin/locationlowinstock') ? 'active' : '' }} "><a href="{{ URL::to('admin/locationlowinstock')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.link_products_low_stock') }}</a></li>
            <li class="{{ Request::is('admin/locationoutofstock') ? 'active' : '' }} "><a href="{{ URL::to('admin/locationoutofstock')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.link_out_of_stock_products') }}</a></li>
...
<!--             <li class="{{ Request::is('admin/location_customers_orders_report') ? 'active' : '' }} "><a href="{{ URL::to('admin/location_customers_orders_report')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.link_customer_orders_total') }}</a></li> -->
            <li class="{{ Request::is('admin/locationstockreport') ? 'active' : '' }}"><a href="{{ URL::to('admin/locationstockreport')}}"><i class="fa fa-circle-o"></i> Stock Report</a></li>
                         <li class="{{ Request::is('admin/locationsalesreports') ? 'active' : '' }}"><a href="{{ URL::to('admin/locationsalesreports')}}"><i class="fa fa-circle-o"></i>Sales Report</a></li>
            ...
            <li class="{{ Request::is('admin/orders/display') ? 'active' : '' }} {{ Request::is('admin/orders/vieworder/*') ? 'active' : '' }}">
              <a href="{{ URL::to('admin/orders/display')}}" >
                <i class="fa fa-circle-o" aria-hidden="true"></i> <span> {{ trans('labels.link_orders') }}</span>
                   ...
                   <li class="{{ Request::is('admin/productorderstatus') ? 'active' : '' }} {{ Request::is('admin/addproductorderstatus') ? 'active' : '' }} {{ Request::is('admin/editproductorderstatus/*') ? 'active' : '' }} "><a href="{{ URL::to('admin/productorderstatus')}}"><i class="fa fa-circle-o"></i> Product Order Item Status</a></li>
            
       <li class="{{ Request::is('admin/purchaseorderstatus') ? 'active' : '' }} {{ Request::is('admin/addpurchaseorderstatus') ? 'active' : '' }} {{ Request::is('admin/editpurchaseorderstatus/*') ? 'active' : '' }} "><a href="{{ URL::to('admin/purchaseorderstatus')}}"><i class="fa fa-circle-o"></i> Purchase Order Item Status</a></li>
                   <li class="{{ Request::is('admin/purchaseordermainstatus') ? 'active' : '' }} {{ Request::is('admin/addpurchaseordermainstatus') ? 'active' : '' }} {{ Request::is('admin/editpurchaseordermainstatus/*') ? 'active' : '' }} "><a href="{{ URL::to('admin/purchaseordermainstatus')}}"><i class="fa fa-circle-o"></i> Purchase Order Main Status</a></li>
            
          </ul>
        </li>
      <?php } ?>
       <?php
        if($result['commonContent']['roles']!= null and $result['commonContent']['roles']->orderdelivery_view == 1 ) {
      ?>
         <li class="treeview {{ Request::is('admin/orderstatus') ? 'active' : '' }} {{ Request::is('admin/addorderstatus') ? 'active' : '' }} {{ Request::is('admin/editorderstatus/*') ? 'active' : '' }} {{ Request::is('admin/orders/display') ? 'active' : '' }} {{ Request::is('admin/orders/vieworder/*') ? 'active' : '' }}">
          <a href="#" ><i class="fa fa-list-ul" aria-hidden="true"></i> <span> Orders Delivery Mapping</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
                  @if($result['commonContent']['roles']!= null and $result['commonContent']['roles']->orderdelivery_mapping == 1)
          
             <li class="{{ Request::is('admin/ordersdeliverymapping/displaydeliverymapping') ? 'active' : '' }} {{ Request::is('admin/ordersdeliverymapping/vieworderdeliverymapping/*') ? 'active' : '' }}">
              <a href="{{ URL::to('admin/ordersdeliverymapping/displaydeliverymapping')}}" >
                <i class="fa fa-circle-o" aria-hidden="true"></i> <span> Orders Delivery Mapping</span>
              </a>
            </li>
            @endif
			
			      <li class="  {{ Request::is('admin/deliveryboy/display') ? 'active' : '' }}  {{ Request::is('admin/deliveryboy/add') ? 'active' : '' }}  {{ Request::is('admin/deliveryboy/edit/*') ? 'active' : '' }} {{ Request::is('admin/deliveryboy/address/display/*') ? 'active' : '' }} {{ Request::is('admin/deliveryboy/filter') ? 'active' : '' }} ">
          <a href="{{ URL::to('admin/deliveryboy/display')}}">
            <i class="fa fa-users" aria-hidden="true"></i> <span>Delivery Boy</span>
          </a>
        </li>
  ...
  <span>{{ trans('labels.link_reports') }}</span> <i class="fa fa-angle-left pull-right"></i>
          ...
          <ul class="treeview-menu">
           ...
           <!-- <li class="{{ Request::is('admin/productsstock') ? 'active' : '' }} "><a href="{{ URL::to('admin/stockin')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.stockin') }}</a></li>-->
            ...
            <li class="{{ Request::is('admin/stockreport') ? 'active' : '' }}"><a href="{{ URL::to('admin/stockreport')}}"><i class="fa fa-circle-o"></i> Stock Report</a></li>
                         <li class="{{ Request::is('admin/salesreports') ? 'active' : '' }}"><a href="{{ URL::to('admin/salesreports')}}"><i class="fa fa-circle-o"></i>Sales Report</a></li>
             
             <li class="{{ Request::is('admin/salesreport') ? 'active' : '' }}"><a href="{{ URL::to('admin/salesreport')}}"><i class="fa fa-circle-o"></i>Daily Sales Report</a></li>
