...
<div class="wrapper wrapper2">
        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="box-tools pull-right">
              <form action="{{ URL::to('admin/locationstockreport')}}" target="_blank">
  ...
  <?php  // print_r(App\Models\Core\Reports::ajax_attr($pro->products_id));
                    $pro1=App\Models\Core\Reports::ajax_attr($pro->products_id);
                    ?>
...
<!--             </ul> -->
  ...
  array_push($attributes, $s1,  $s2);
   ...
   $currentStockComplex1=App\Models\Core\Reports::currentstock($pro->products_id,$attributes);
...
echo "</p>";
   // echo $csc['Options_values'];
  	...
  	$currentStockComplex2=App\Models\Core\Reports::currentstock($pro->products_id,$attributes);
...
<!--             </div> -->
         	     ...
         	     <?php 
         	      ...
         	      $currentStock=App\Models\Core\Reports::ajax_min_max($pro->products_id);
         	     /* 
         	     ...
         	     if($currentStock['purchase_price']){
         	     	echo "PurchasePrice ".$currentStock['purchase_price'];
         	     }else{
         	     	echo "PurchasePrice 0";
