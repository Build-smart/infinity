                          ...
                          <h3 class="box-title">Edit category</h3>
                            ...
                            <h3 class="box-title">{{ trans('labels.AddCoupons') }}</h3>
                                	...
                                	{{ trans('labels.CouponAmountText') }}</span>
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-2 control-label">{{ trans('labels.Minimumspend') }}
                                                </label>
                                                <div class="col-sm-10 col-md-9">
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-2 control-label">{{ trans('labels.MaximumSpend') }}
                                                </label>
                                                <div class="col-sm-10 col-md-9">
