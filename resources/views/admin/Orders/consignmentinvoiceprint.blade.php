...
@endif
         @endforeach
              ...
              <td> 
               @php $total_taxable_amount += $products->cart_product_price * $products->products_quantity;    @endphp
               
              {{ $products->cart_product_price * $products->products_quantity}}</td>
              <td>{{ $products->product_tax_rate }} %</td>
              <td>
              @php $total_tax += $products->products_tax;    @endphp
              
              {{ $products->products_tax }}</td>
              <td>
              
              
              {{ ($products->cart_product_price * $products->products_quantity) + $products->products_tax}} </td>
             </tr>
            @endforeach
             <tr>
            <th>Total</th>
    ...
    <tr>
        ...
        <td align="right">                    @if(!empty($result['commonContent']['currency']->symbol_left)) {{$result['commonContent']['currency']->symbol_left}} @endif {{ $total_taxable_amount }} @if(!empty($result['commonContent']['currency']->symbol_right)) {{$result['commonContent']['currency']->symbol_right}} @endif
    ...
    @if($data['orders_data'][0]->billing_state == "TS")
     <tr>
        ...
        <td align="right">                    @if(!empty($result['commonContent']['currency']->symbol_left)) {{$result['commonContent']['currency']->symbol_left}} @endif {{$total_tax/2}} @if(!empty($result['commonContent']['currency']->symbol_right)) {{$result['commonContent']['currency']->symbol_right}} @endif
    ...
    @else
     <tr>
        ...
        <td align="right">                    @if(!empty($result['commonContent']['currency']->symbol_left)) {{$result['commonContent']['currency']->symbol_left}} @endif {{ $total_tax }} @if(!empty($result['commonContent']['currency']->symbol_right)) {{$result['commonContent']['currency']->symbol_right}} @endif
...
$number = $total_taxable_amount+$total_tax;
   $no = floor($number);
 ...
 ?> </td>
        ...
        <td align="right">       @if(!empty($result['commonContent']['currency']->symbol_left)) {{$result['commonContent']['currency']->symbol_left}} @endif {{ $total_taxable_amount+$total_tax }} @if(!empty($result['commonContent']['currency']->symbol_right)) {{$result['commonContent']['currency']->symbol_right}} @endif</td>
