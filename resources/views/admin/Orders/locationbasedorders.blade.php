                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-6 form-inline" id="contact-form">
                                    <form name='registration' id="registration" class="registration" method="get" action="{{url('admin/orders/locationfilter')}}">
                                        ...
                                        <div class="input-group-form search-panel ">
                                            ...
                                            @if(isset($parameter,$filter)) <a class="btn btn-danger " href="{{url('admin/orders/locationorderdisplay')}}"><i class="fa fa-ban" aria-hidden="true"></i> </a>@endif
                                        </div>
                                    </form>
