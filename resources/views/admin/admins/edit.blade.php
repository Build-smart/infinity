                         ...
                         <div class="box-body">
                            ...
                            <div class="form-group">
                                  ...
                                  {{ trans('labels.AdminTypeText') }}</span>
                                     ...
                                     <div class="form-group">
                                  <label for="name" class="col-sm-2 col-md-3 control-label">Locations </label>
                                  <div class="col-sm-10 col-md-4">
                                    <select class="form-control" name="location_id">
                                    @foreach($result['locations'] as $location)
                                          <option value="{{$location->id}}" @if($result['admins'][0]->location_id==$location->id) selected @endif>{{$location->location_name}}</option>
                                    @endforeach
									</select>
                                  <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
