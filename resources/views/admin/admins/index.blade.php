...
<div class="content-wrapper">
  ...
  <section class="content">
                   ...
                   {{ $admin->email }} 
                              ...
                              <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li role="presentation"><a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Delete') }}" id="deleteAdminUserFrom" customers_id="{{ $admin->id }}">{{ trans('labels.Delete') }}</a></li>
                                </ul>
                              </li>
                            </ul>
								</td>
    ...
    <!-- deleteCustomerModal -->
	<div class="modal fade" id="deleteAdminUserModal" tabindex="-1" role="dialog" aria-labelledby="deleteAdminUserModalLabel">
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			<h4 class="modal-title" id="deleteAdminUserModalLabel">{{ trans('labels.deleteAdmin') }}</h4>
		  </div>
