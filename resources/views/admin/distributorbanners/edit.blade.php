...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> Edit Distributor Banner <small> Edit Distributor Banner...</small> </h1>
            <ol class="breadcrumb">
                <li><a href="{{ URL::to('admin/dashboard/this_month') }}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
                <li><a href="{{ URL::to('admin/distributorbanners')}}"><i class="fa fa-bars"></i>  All Distributor Banner List</a></li>
                <li class="active"> Edit Distributor Banner</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Edit Distributor Banner</h3>
                        </div>
                        ...
                        <div class="box-body">
                          ...
                          <h3 class="box-title">Edit category</h3>
                                        ...
                                        <div class="box-body">
                                            ...
                                            {!! Form::open(array('url' =>'admin/distributorbanners/update', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}

                                            {!! Form::hidden('id',  $result['distributorbanners'][0]->distributorbanners_id, array('class'=>'form-control', 'id'=>'id')) !!}
                                            {!! Form::hidden('oldImage',  $result['distributorbanners'][0]->distributorbanners_image, array('id'=>'oldImage')) !!}

                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Title') }} </label>
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text('distributorbanners_title', $result['distributorbanners'][0]->distributorbanners_title, array('class'=>'form-control','id'=>'distributorbanners_title')) !!}
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <select class="form-control" name="position">
                                                            <option value="TOP" @if($result['distributorbanners'][0]->display_position=="TOP") selected @endif >TOP</option>
                                                            <option value="BOTTOM" @if($result['distributorbanners'][0]->display_position=="BOTTOM") selected @endif>BOTTOM</option>
                                                        </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <img src="{{asset($result['distributorbanners'][0]->path)}}" alt="" width=" 100px">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select class="form-control" name="type" id="bannerType">
                                                        <option value="category" @if($result['distributorbanners'][0]->type=='category') selected @endif>
                                                            {{ trans('labels.ChooseSubCategory') }}</option>
<!--                                                         <option value="product" @ if($result['banners'][0]->type=='product') selected @ endif>Product</option> -->
                                                        <option value="top seller" @if($result['distributorbanners'][0]->type=='top seller') selected @endif>Top Seller</option>
                                                        <option value="deals" @if($result['distributorbanners'][0]->type=='deals') selected @endif>Deals</option>
                                                        <option value="most liked" @if($result['distributorbanners'][0]->type=='most liked') selected @endif>Most Liked</option>
                                                    </select>
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    {!! Form::text('banners_url', '', array('class'=>'form-control','id'=>'banners_url')) !!}
                                            ...
                                            <div class="form-group categoryContent" @if($result['distributorbanners'][0]->type!='category') style="display: none" @endif >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    @if(!empty($result['distributorbanners'][0]->expires_date))
                                                        {!! Form::text('expires_date', date('d/m/Y', strtotime($result['distributorbanners'][0]->expires_date)), array('class'=>'form-control datepicker', 'id'=>'expires_date')) !!}
                                                    @else
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select class="form-control" name="status">
                                                        <option value="1" @if($result['distributorbanners'][0]->status==1) selected @endif>{{ trans('labels.Active') }}</option>
                                                        <option value="0" @if($result['distributorbanners'][0]->status==0) selected @endif>{{ trans('labels.Inactive') }}</option>
                                                    </select>
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
