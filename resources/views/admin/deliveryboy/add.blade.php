...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> Add Delivery Boy<small>Add Delivery Boy...</small> </h1>
        <ol class="breadcrumb">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        {!! Form::open(array('url' =>'admin/deliveryboy/add', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
