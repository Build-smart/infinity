...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> Edit Delivery Boy <small>Edit Current Delivery Boy ...</small> </h1>
        <ol class="breadcrumb">
            <li><a href="{{ URL::to('admin/dashboard/this_month')}}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
            <li><a href="{{ URL::to('admin/deliveryboy/display')}}"><i class="fa fa-users"></i> List All The Delivery Boy</a></li>
                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        {!! Form::open(array('url' =>'admin/deliveryboy/update', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                        ...
                                        <div class="box-footer text-center">
                                            ...
                                            <a href="{{ URL::to('admin/deliveryboy/display')}}" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
                                        </div>
                                        <!-- /.box-footer -->
                                        {!! Form::close() !!}
                                    </div>
