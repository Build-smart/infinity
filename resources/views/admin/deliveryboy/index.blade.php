...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> Delivery Boys <small>List All The Delivery Boys...</small> </h1>
        <ol class="breadcrumb">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-6 form-inline" id="contact-form">
                                    <form name='registration' id="registration" class="registration" method="get" action="{{url('admin/deliveryboy/filter')}}">
                                        ...
                                        <div class="input-group-form search-panel ">
                                            ...
                                            @if(isset($parameter,$filter)) <a class="btn btn-danger " href="{{url('admin/deliveryboy/display')}}"><i class="fa fa-ban" aria-hidden="true"></i> </a>@endif
                                        </div>
                                    </form>
                                    <div class="col-lg-4 form-inline" id="contact-form12"></div>
                                </div>
                                <div class="box-tools pull-right">
                                    <a href="{{ url('admin/deliveryboy/add')}}" type="button" class="btn btn-block btn-primary">{{ trans('labels.AddNew') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <ul class="nav table-nav">
                                                    <li class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li role="presentation"><a role="menuitem" tabindex="-1" href="{{url('admin/deliveryboy/edit') }}/{{$listingCustomers->id}}">Edit Delivery Boy</a></li>
                                                            <li role="presentation" class="divider"></li>
                                                            <li role="presentation"><a role="menuitem" tabindex="-1" href="{{url('admin/deliveryboy/address/display/'.$listingCustomers->id) }}">{{ trans('labels.EditAddress') }}</a></li>
                                                            <li role="presentation" class="divider"></li>
        ...
        <div class="modal fade" id="deleteCustomerModal" tabindex="-1" role="dialog" aria-labelledby="deleteCustomerModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    {!! Form::open(array('url' =>'admin/deliveryboy/delete', 'name'=>'deleteCustomer', 'id'=>'deleteCustomer', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
