...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> Add Address<small> Add Current Address...</small> </h1>
            <ol class="breadcrumb">
                <li><a href="{{ URL::to('admin/dashboard/this_month')}}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
                <li><a href="{{ URL::to('admin/deliveryboy/display')}}"><i class="fa fa-users"></i> List All The Delivery Boys</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Listing Delivery Boy Address</h3>
                        ...
                        <div class="box-body">
                            ...
                            <div class="box-footer text-center">
                                <a href="{{ URL::to('admin/deliveryboy/display')}}" class="btn btn-primary">{{ trans('labels.SaveComplete') }}</a>
                            </div>
                            <!-- /.box-body -->
                        </div>
                        ...
                        <div class="modal fade" id="deleteAddressModal" tabindex="-1" role="dialog" aria-labelledby="deleteAddressModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    {!! Form::open(array('url' =>'admin/deliveryboy/deleteAddress', 'name'=>'deleteAddress', 'id'=>'deleteAddress', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
