...
<!--                         <div sty le="margin-right:88px;"class="box-tools pull-left"> -->
<!--                             <button id="btn" type="button" class="btn btn-block btn-danger">Delete</button> -->

<!--                         </div> -->
<!--                         <div sty le="margin-right:162px;"class="box-tools pull-left"> -->
<!--                             <button id="btn11" type="button" class="btn btn-block btn-success" >Select All</button> -->

<!--                         </div> -->
<!--                         <div st yle="margin-right:253px;"class="box-tools pull-left"> -->
...
/*    img:hover { border:7px solid #ff0000;   } */
/*   img.hover { border: 7px solid #ff0000;   } */
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary"   id="compeleteimage"
