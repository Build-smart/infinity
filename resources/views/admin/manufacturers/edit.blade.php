                                        ...
                                        <div class="box-body">
											...
											<div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                       <select class="form-control field-validate" name="categories_id">
                                                        <option value="">Select Catgeory</option>
                                                       @foreach ($result['categories'] as $category)
                                                       
                                                       
                                                       
                                                            <option @if($category->id == $editManufacturer->category_id )
                                                                selected
                                                                @endif
                                                                value="{{ $category->id }}">{{ $category->name }}</option>
                                                            @endforeach
                                                    </select>
                                                       <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">Please Select Category</span>
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <!-- Modal -->
                                                        ...
                                                        <div id ="imageselected">
                                                            ...
                                                            <div class="closimage">
                                                                <button type="button" class="close pull-right product_image_close" id="image-close" style="display: none; position: absolute;left: 91px; top: 54px; background-color: black; color: white; opacity: 2.2;" aria-label="Close">
