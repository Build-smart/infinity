...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> Add Client<small> Add Client</small> </h1>
            <ol class="breadcrumb">
                <li><a href="{{ URL::to('admin/dashboard/this_month')}}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
                <li><a href="{{ URL::to('admin/clients')}}"><i class="fa fa-dashboard"></i>Client List</a></li>
                                ...
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            {!! Form::open(array('url' =>'admin/addnewclient', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}

 
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-2 control-label">Client Name</label>
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" name="client_name" Placeholder="Enter Client Name" class="form-control field-validate"  >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" name="client_phone" Placeholder="Enter Phone Number" class="form-control field-validate"  >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" name="client_email" Placeholder="Enter Email" class="form-control field-validate"  >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" name="client_address" Placeholder="Enter Address" class="form-control  "  >
