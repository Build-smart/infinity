                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Add Reward Points</h3>
                        </div>
                                ...
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            {!! Form::open(array('url' =>'admin/addnewrewardpoint', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}

 
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-2 control-label">Minimum Cart Value</label>
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" name="min_cart_value" Placeholder="Enter Minimum Cart Value" class="form-control field-validate"  >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" name="reward_point" Placeholder="Enter Reward Points" class="form-control field-validate"  >
