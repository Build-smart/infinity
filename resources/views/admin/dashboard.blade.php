            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-xs-6">
                  ...
                  <div class="small-box bg-teal">
                    <div class="inner">
                      <h3>@if(!empty($result['commonContent']['currency']->symbol_left)) {{$result['commonContent']['currency']->symbol_left}} @endif {{ $result['total_sale_amount'] }} @if(!empty($result['commonContent']['currency']->symbol_right)) {{$result['commonContent']['currency']->symbol_right}} @endif</h3>
        			  <p>{{ trans('labels.Total Money Earned') }} Amount</p>
                    </div>
                    <div class="icon">
                      <i class="ion ion-bag"></i>
                    </div>
                ...
                <div class="col-lg-4 col-xs-6">
                  ...
                  <div class="small-box bg-light-blue">
                    <div class="inner">
                      <h3>@if(!empty($result['commonContent']['currency']->symbol_left)) {{$result['commonContent']['currency']->symbol_left}} @endif {{ $result['purchase_total_sale_amount'] }} @if(!empty($result['commonContent']['currency']->symbol_right)) {{$result['commonContent']['currency']->symbol_right}} @endif</h3>
        			  <p>Total Purchased Amount</p>
                    </div>
                    <div class="icon">
                      <i class="ion ion-bag"></i>
                    </div>
