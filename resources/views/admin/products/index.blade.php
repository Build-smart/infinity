                           ...
                           <div class="col-lg-10 form-inline">
                                ...
                                <form  name='registration' id="registration" class="registration" method="get">
                                    ...
                                    <div class="input-group-form search-panel ">
                                        ...
                                        <select id="FilterBy" type="button" class="btn btn-default dropdown-toggle form-control input-group-form " data-toggle="dropdown" name="location_id">

                                            
                                            @foreach ($results['locations'] as  $key=>$location)
                                                <option value="{{ $location->id }}"
                                                @if(isset($_REQUEST['location_id']) and !empty($_REQUEST['location_id']))
                                                        
                                                @if( $location->id == $_REQUEST['location_id'])
                                                            selected
                                                          @endif @endif>{{ $location->location_name }}</option>
                                            @endforeach
                                        </select>
                                        
  <input type="text" class="form-control input-group-form " name="product" placeholder="Search By Product ID Or Name" size="40" id="parameterX"  @if(isset($product)) value="{{$product}}" @endif />                                      
                                                    ...
                                                    <td>
                                                       ...
                                                       @if(!empty($product->specials_id))
                                                           ...
                                                           ?> 
                                                            ...
                                                            <input class="form-control special_price_percentage" data-id="{{$product->products_id}}" id="specialproductpricepercentage_{{$product->products_id}}" value="<?php echo $discounted_percentage; ?>">
