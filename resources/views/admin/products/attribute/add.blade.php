                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th>{{ trans('labels.Price') }}</th>
                                                                                         <th>Distributor Option Price</th>
                                        ...
                                        @if (count($result['products_attributes']) > 0)
                                          ...
                                          <td>{{ $products_attributes->price_prefix }}{{ $products_attributes->distributor_options_values_price }}</td>
                                  ...
                                  {{ trans('labels.OptionValuesText') }}</span>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="name" class="col-sm-2 col-md-4 control-label">Distributor Option Value Price</label>
                                                        <div class="col-sm-10 col-md-8">
                                                               {!! Form::text('distributor_options_values_price',  '0', array('class'=>'form-control', 'id'=>'distributor_options_values_price')) !!}
                                                            <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.NumericValueError') }}</span>
