  ...
  <div class="form-group">
   ...
   <div class="form-group">
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-10 col-md-8">
		 {!! Form::text('distributor_options_values_price',  $result['products_attributes'][0]->distributor_options_values_price, array('class'=>'form-control', 'id'=>'distributor_options_values_price')) !!}
         <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.NumericValueError') }}</span>
	  </div>
	</div>
