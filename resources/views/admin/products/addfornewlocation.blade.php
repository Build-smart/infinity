                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        {!! Form::open(array('url' =>'admin/products/addfornewlocation', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-md-6">
                                                ...
                                                <!-- Bharath Duplicated Product Id Input -->
                                              <input type="hidden"  name="duplicated_from_producted_id" value="{{$result['product'][0]->products_id}}">
                                             <!-- Bharath Duplicated Product Id Input -->
                                          ...
                                          <div class="col-xs-12 col-md-6">
                                                ...
                                                <div class="form-group" id="location_id">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('Product Location') }} </label>
                                                    <div class="col-sm-10 col-md-8">
                                                        <select class="form-control field-validate" name="location_id">
                                                            ...
                                                            <option @if($result['product'][0]->location_id == $locations->id )
                                                                selected
                                                                @endif
                                                                value="{{ $locations->id }}">{{ $locations->location_name }}</option>
                                                            @endforeach
                                                        </select>
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">Product Segment</label>
                                                    <div class="col-sm-10 col-md-8">
                                                        <select class="form-control field-validate" name="product_segment">
                                                            <option value="">Choose Segment</option>
                                                            <option value="ECONOMY" @if($result['product'][0]->product_segment=="ECONOMY") selected @endif>ECONOMY</option>
                                                            <option value="STANDARD" @if($result['product'][0]->product_segment=="STANDARD") selected @endif>STANDARD</option>
                                                            <option value="PREMIUM" @if($result['product'][0]->product_segment=="PREMIUM") selected @endif>PREMIUM</option>
                                                        </select><span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                            {{ trans('labels.Product Type Text') }}.</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                ...
                                                <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">Select Distributor </label>
                                                    <div class="col-sm-10 col-md-8">
                                                        <select class="form-control field-validate" name="distributor_id">
                                                            <option value="">Choose Distributor</option>
                                                            @foreach ($result['distributors'] as $distributor)
                                                            <option @if($result['product'][0]->distributor_id == $distributor->id )
                                                                selected
                                                                @endif
                                                                value="{{ $distributor->id }}">{{ $distributor->first_name }}</option>
                                                            @endforeach
                                                        </select>
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                            {{ trans('labels.ChooseManufacturerText') }}.</span>
                                      ...
                                      <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        {!! Form::text('products_price', $result['product'][0]->products_price, array('class'=>'form-control products_price products_price_distributor number-validate ', 'id'=>'products_price')) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        {!! Form::text('distributor_product_price_percentage', $result['product'][0]->distributor_product_price_percentage, array('class'=>'form-control number-validate distributor_product_price_percentage', 'id'=>'distributor_product_price_percentage')) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                            {{ trans('labels.ProductPriceText') }}
                                                        </span>
                                                        <span class="help-block hidden">{{ trans('labels.ProductPriceText') }}</span>
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">Distributor {{ trans('labels.ProductsPrice') }}</label>
                                                    <div class="col-sm-10 col-md-8">
                                                        {!! Form::text('distributor_product_price', $result['product'][0]->distributor_product_price, array('class'=>'form-control  number-validate', 'id'=>'distributor_product_price')) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                            {{ trans('labels.ProductPriceText') }}
                                                        </span>
                                                        <span class="help-block hidden">{{ trans('labels.ProductPriceText') }}</span>
                                        ...
                                        <div class="row">
											...
											<div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">HSN/SAC Code</label>
                                                    <div class="col-sm-10 col-md-8">
                                                        {!! Form::text('hsn_sac_code', $result['product'][0]->hsn_sac_code, array('class'=>'form-control  field-validate', 'id'=>'hsn_sac_code')) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                            Enter HSN/SAC Code
                                                        </span>
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        ...
                                                        <input type="hidden" id="product_id" name="image_id" value="{{$result['product'][0]->products_image}}">
												...
												<div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">Select Assured By </label>
                                                    <div class="col-sm-10 col-md-8">
                                                        <select class="form-control" name="assured_by">
                                                            <option value="" @if($result['product'][0]->assured_by=="") selected @endif >Select Assured By</option> 
                                                            <option value="BM" @if($result['product'][0]->assured_by=="BM") selected @endif >BM ASSURED</option>
                                                         </select>
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                            {{ trans('labels.SelectStatus') }}</span>
                                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                ...
                                                <div class="special-container" style="display: none;">
                                                    <div class="form-group">
                                                        <label for="name" class="col-sm-2 col-md-3 control-label">Special Price Percentage</label>
                                                        <div class="col-sm-10 col-md-8">
                                                           <input type="text" class="form-control special_price_percentage" value=" " name="specials_new_products_price_percentage" id="special_price_percentage">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10 col-md-8">
                                                            ...
                                                            {!! Form::text('specials_new_products_price', $result['specialProduct'][0]->specials_new_products_price, array('class'=>'form-control', 'readonly', 'id'=>'special_price')) !!}
                                                            <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                                {{ trans('labels.SpecialPriceTxt') }}.</span>
...
<script>
   ...
   let original_price=	$('#products_price').val();
   let dicount_price=$( '#special_price').val();


   let discounted_price=  original_price -dicount_price;


let discount_percentage= discounted_price/original_price*100;

   

$('#special_price_percentage').val(Math.trunc(discount_percentage));
