...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> Edit Construction Resource <small>Edit Construction Resource...</small> </h1>
            <ol class="breadcrumb">
                <li><a href="{{ URL::to('admin/dashboard/this_month')}}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
                <li><a href="{{ URL::to('admin/constructionresources')}}"><i class="fa fa-dashboard"></i>Construction Resources List</a></li>
                <li class="active">Edit Construction Resource</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Edit Construction Resource</h3>
                        </div>
                                ...
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            {!! Form::open(array('url' =>'admin/updateconstructionresource', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                            {!! Form::hidden('id', $result['constructionresources']->id, array('class'=>'form-control', 'id'=>'id'))!!}
												...
												<div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                       ...
                                                       @foreach ($result['locations'] as $location)
                                                          <option @if($result['constructionresources']->city == $location->location_name )
                                                                selected
                                                                @endif
                                              ...
                                              <option value="ECONOMY" @if($result['constructionresources']->materialquality=="ECONOMY") selected @endif>ECONOMY</option>
                                             <option value="STANDARD" @if($result['constructionresources']->materialquality=="STANDARD") selected @endif>STANDARD</option>
                                                  <option value="PREMIUM" @if($result['constructionresources']->materialquality=="PREMIUM") selected @endif>PREMIUM</option>
                                                            
                                                        
                                                    </select> <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">Please Select Material Quality</span>
                                                        <span class="help-block hidden">{{ trans('labels.textRequiredFieldMessage') }}</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" name="cement" value="{{$result['constructionresources']->cement}}" Placeholder="Enter Cement" class="form-control field-validate"  >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" name="steel"  value="{{$result['constructionresources']->steel}}" Placeholder="Enter Steel" class="form-control  "  >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" name="bricks"  value="{{$result['constructionresources']->bricks}}" Placeholder="Enter Bricks" class="form-control  "  >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" name="aggregate"  value="{{$result['constructionresources']->aggregate}}" Placeholder="Enter Aggregate" class="form-control  "  >
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" name="sand"  value="{{$result['constructionresources']->sand}}" Placeholder="Enter Sand" class="form-control  "  >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" name="flooring"  value="{{$result['constructionresources']->flooring}}" Placeholder="Enter Flooring" class="form-control  "  >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" name="windows"  value="{{$result['constructionresources']->windows}}" Placeholder="Enter Windows" class="form-control  "  >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" name="doors"  value="{{$result['constructionresources']->doors}}" Placeholder="Enter Doors" class="form-control  "  >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" name="electricalfittings"  value="{{$result['constructionresources']->electricalfittings}}"  Placeholder="Enter Electrical Fittings" class="form-control  "  >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" name="painting"  value="{{$result['constructionresources']->painting}}" Placeholder="Enter Painting" class="form-control  "  >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" name="sanitaryfitting"   value="{{$result['constructionresources']->sanitaryfitting}}" Placeholder="Enter Sanitary Fitting" class="form-control  "  >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" name="kitchenwork"  value="{{$result['constructionresources']->kitchenwork}}" Placeholder="Enter Kitchen Work" class="form-control  "  >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" name="contractorcharges"  value="{{$result['constructionresources']->contractorcharges}}" Placeholder="Enter Contractor Charges" class="form-control  "  >
