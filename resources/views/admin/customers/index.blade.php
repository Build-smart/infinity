                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               ...
                                               <td>
                                             @if($listingCustomers->customer_type == "BUSINESSOWNER")
                                           				 Workforce -{{$listingCustomers->workforce_name}}
                                           				   
                                           				 
                                              @elseif($listingCustomers->customer_type == "CLIENT")
                                                Home Builder or House Contractor
                                             @else
                                             {{ $listingCustomers->customer_type }}
                                             @endif
                                              </td>
                                              <td>
