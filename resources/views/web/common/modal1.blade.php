<div class="row ">
  <div class="col-12 col-md-6">
    ...
    <div class="pro-price">                     
      ...
      @if(!empty($result['detail']['product_data'][0]->flash_price))
      <ins class="total_price"> {{Session::get('symbol_left')}}{{$flash_price+0}}{{Session::get('symbol_right')}}</ins>
      ...
      <ins class="total_price">{{Session::get('symbol_left')}}{{$discount_price+0}}{{Session::get('symbol_right')}}</ins>
      <del class="original_price">{{Session::get('symbol_left')}}{{$orignal_price+0}}{{Session::get('symbol_right')}}</del>
      @else
    ...
    <div class="pro-infos">
        ...
        <div class="pro-single-info"><b>@lang('website.Available') :</b>
          ...
          @endif
           ...
           <!-- display attributes out of stock in model1 on 19-2-2022-->
...
<!-- for product selected name  11-2-2022-->
    ...
    ?>
      ...
      <div class="pro-options">
            <div class="box mb-3">
              ...
              <select name="{{ $attributes_data['option']['id'] }}" style="width:150px" onChange="getQuantity(0)" class="currentstock form-control attributeid_<?=$index++?>" attributeid = "{{ $attributes_data['option']['id'] }}">
                @if(!empty($result['cart']))
                  @php
                   $value_ids = array();
