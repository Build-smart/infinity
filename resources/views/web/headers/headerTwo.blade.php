      ...
      <div class="row align-items-center">
        <div class="col-12 col-sm-12 col-lg-3">
          <a href="{{ URL::to('/')}}" class="logo" data-toggle="tooltip" data-placement="bottom" title="@lang('website.logo')">
            ...
            <img class="img-fluid" style="width:70%"  src="{{asset('').$result['commonContent']['settings']['website_logo']}}" alt="<?=stripslashes($result['commonContent']['settings']['website_name'])?>">
            @endif
            </a>
        </div>
                ...
                <li class="nav-item ">
                  <a class="nav-link">
                      <span>@lang('website.hotline')</span>
                                        <span style="background-color: #eeeeee;color:#000000;"> {{$result['commonContent']['setting'][11]->value}} </span>
                  </a>
                </li>
          </ul>
        </div>
