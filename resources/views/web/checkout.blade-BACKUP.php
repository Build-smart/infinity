                     ...
                     <div class="form-row">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <input required type="text" class="form-control" id="delivery_alternate_phone" aria-describedby="numberHelp" placeholder="@lang('website.Enter Your Phone Number')" name="delivery_alternate_phone" value="@if(!empty(session('shipping_address'))){{session('shipping_address')->delivery_alternate_phone}}@endif">
                          <span style="color:red;" class="help-block error-content" hidden>@lang('website.Please enter your valid phone number')</span>
                        </div>
