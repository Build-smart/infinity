...
<section id="hero" class="">
        ...
        <div class="hero-content aos-init aos-animate" data-aos="fade-up" style="background-image: url({{asset('images/construction/career.jpg')}});background-repeat:  no-repeat;  background-size: cover;">

    
      <h2>Come Build  <span>Your Career With</span><br>BuilderMart</h2>
