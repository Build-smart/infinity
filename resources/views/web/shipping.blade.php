               ...
               @endif
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group select-control col-md-6">
                      ...
                      <select name="entry_zone_id"  id="entry_zone_id" onChange="getCities();" class="form-control field-validate">
                      ...
                      <select required class="form-control field-validate" id="city"  name="entry_city" aria-describedby="cityHelp">
                              <option value="" selected>Select City</option>
                              @if(!empty($result['locations']))
                                @foreach($result['locations'] as $location)
                                    <option value="{{$location->location_name}}" @if(!empty($result['editAddress'])) @if($location->location_name==$result['editAddress'][0]->city) selected @endif @endif>{{$location->location_name}}</option>
                                @endforeach
                              @endif
                              </select>
