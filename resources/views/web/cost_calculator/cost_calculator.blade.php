	...
	<div class="container">
			...
			<div class="row ">
				<div class="col-12 col-sm-12 col-md-6 bordershadows">
					  	<form  enctype="multipart/form-data"  method="get"  class="form-validate-login" action="{{ URL::to('/cost_calculator')}}" >
							{{csrf_field()}}
					...
					<div class="col-12"><h4 class="heading login-heading">Select Location</h4></div>
					 			...
					 			<div class="from-group mb-3">
												...
												<div class="from-group mb-3">
													<div class="col-12" > <label for="inlineFormInputGroup"> Enter Area <strong  style="color: red;">*</strong></label></div>
												<div class="input-group col-12">
													
														<input type="number" name="area" id="area" value="{{Session::get('SELECTEDAREA')}}" required="required"  placeholder="Enter In Square Feet" class="form-control">
					...
					<div class="col-12 col-sm-12 col-md-6 bordershadows">
					<div class="col-12"><h4 class="heading login-heading">Total Estimation Cost</h4></div>
					<div class="from-group mb-3">
