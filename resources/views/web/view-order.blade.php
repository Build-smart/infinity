        ...
        <div class="row">
          ...
          <div class="col-12 col-md-7">
              ...
              <table class="table order-id">
                  <tbody>
                      <tr class="d-flex">
                        <td class="address col-12 col-md-12"><strong>Name: </strong>{{$result['orders'][0]->delivery_name}}, <strong>Phone Number: </strong>{{$result['orders'][0]->delivery_phone}}<br>
                        <strong>Alternate Phone Number: </strong> {{$result['orders'][0]->delivery_alternate_phone}}</td>


                      </tr>
                      <tr class="d-flex">
                          <td  class="address col-12 col-md-12"><strong>Address: </strong>{{$result['orders'][0]->delivery_street_address}}, {{$result['orders'][0]->delivery_city}}, {{$result['orders'][0]->delivery_state}},
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-5">
                ...
                <table class="table order-id">
                  <tbody>
                      <tr class="d-flex">
                        <td class="address col-12"><strong>Name: </strong>{{$result['orders'][0]->billing_name}},<br> <strong>Phone Number: </strong>{{$result['orders'][0]->billing_phone}} ,
                        <br><strong>Alternate Phone Number: </strong> {{$result['orders'][0]->billing_alternate_phone}}</td>
                      </tr>
                      <tr  class="d-flex">
                          <td class="address col-12"><strong>Address: </strong>{{$result['orders'][0]->billing_street_address}}, {{$result['orders'][0]->billing_city}}, {{$result['orders'][0]->billing_state}},
        ...
        <table class="table items">
          ...
          <tbody>
            ...
            <tr class="d-flex responsive-lay">
              ...
              <td  class="tag-s col-12 col-md-2">Status: <br><span class="badge badge-success"> {{$products->product_orders_status_name}}</span> </td>
