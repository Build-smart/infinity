          ...
          <div class="col-lg-12 entries">
            ...
            <article class="entry entry-single">
              ...
              <h2 class="entry-title">
                <a href="#">{{$job_details->job_title}}</a>
              </h2>

              
                <ul  >
                  <li  >   <b>Job Type:</b> {{$job_details->job_type}} </li> 
                  <li  >   <b>Experience:</b> {{$job_details->experience}} </li> 
                  <li  > <b> No Of Positions:</b> {{$job_details->no_of_positions}}  </li> 
                  <li  >   <b>Location:</b> {{$job_details->location}} </li> 
                </ul>
 ...
 <div class="reply-form">
                ...
                <p>Your email address will not be published. Required fields are marked * </p>
                 <form enctype="multipart/form-data"  id="upload_form" method="post">
                  ...
                  <div class="row">
                  <input name="job_title" type="hidden" value="{{$job_details->job_title}}" class="form-control" required="required" placeholder="Enter Name">
                   ...
                   <div class="row">
                    <div class="col-md-6 form-group">
                      ...
                      <input name="phone"  maxlength="10" pattern="([0-9]{10})" type="text" class="form-control" placeholder="Enter Phone Number" required="required">
                    </div>
                    <div class="col-md-6 form-group">
...
$("#phone_number").keyup(function() {
    $("#phone_number").val(this.value.match(/[0-9]*/));
});
